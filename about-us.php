  ...
  ?>
        ...
        <div class="container sign-in-up">
          <div class="row">
            ...
            <div class="col-md-7" style="width: 300px;margin: auto;">
              <h1>Brook<sapn class="font-weight-bold">Wood</sapn></h1>
              <p>
                Welcome to BrookWood, your number one source for all things.
                BrookWood Management System is a process in which we can order 
                ...
                BrookWood has come a long way from its beginnings. BrookWood 
