...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2023 at 07:13 AM
...
(6, 'Elroy Merwyn Monis', 'xyz@gmail.com', '123emm2u', 'OLIVET 76 badagabettu Bailoor Udupi 576101', 'Udupi', '576101', '8050393508');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `customer_order`
  MODIFY `order_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
